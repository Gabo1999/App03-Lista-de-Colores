...
extension Colour {
    ...
    static let flatUI = [Alizarin, Amethyst, Asbestos, BelizeHole, Carrot, Clouds, Concrete, Emerald, GreenSea, MidnightBlue, Nephritis, Orange, PeterRiver, Promegranate, Pumkin, Silver, SunFlower, Turquoise, WetAsphalt
    ]
